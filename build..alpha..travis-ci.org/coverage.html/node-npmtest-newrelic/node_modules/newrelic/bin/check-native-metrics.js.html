...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-newrelic/node_modules/newrelic/bin/check-native-metrics.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-newrelic/node_modules/newrelic/bin/check-native-metrics.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-newrelic/node_modules/newrelic/bin/</a> &#187; check-native-metrics.js</div>
</div>
<div class="body">
...
<span class="missing-if-branch" title="if path not taken" >I</span>if (process.env.NEW_RELIC_SKIP_NATIVE_METRICS) {
...
&nbsp;
  var npmVersion = (npmVersionStr || <span class="branch-1 cbranch-no" title="branch not covered" >'')</span>.split('.').map(function versionMap(a) {
    return parseInt(a, 10)
  })
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (npmVersion.length &gt;= 3 &amp;&amp; npmVersion[0] &gt;= 2) {
...
&nbsp;
      var nodeVersion = (nodeVersionStr || <span class="branch-1 cbranch-no" title="branch not covered" >'')</span>.substr(1).split('.')
        .map(function versionMap(a) {
          return parseInt(a, 10)
        }
      )
&nbsp;
      <span class="missing-if-branch" title="else path not taken" >E</span>if (nodeVersion.length &gt;= 3 &amp;&amp; nodeVersion[0] !== 5) {
        console.log(
        ...
        cp.exec('npm install @newrelic/native-metrics', function installCB(err) {
          <span class="missing-if-branch" title="if path not taken" >I</span>if (err) {
<span class="cstat-no" title="statement not covered" >            console.log('Failed to install @newrelic/native-metrics')</span>
