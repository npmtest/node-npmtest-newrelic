...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-newrelic/node_modules/newrelic/lib/util/arrays.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-newrelic/node_modules/newrelic/lib/util/arrays.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-newrelic/node_modules/newrelic/lib/util/</a> &#187; arrays.js</div>
</div>
<div class="body">
 ...
 */
<span class="fstat-no" title="function not covered" >function arrayFind(arr, pred, ctx) {</span>
<span class="cstat-no" title="statement not covered" >  var idx = arrayFindIndex(arr, pred, ctx)</span>
<span class="cstat-no" title="statement not covered" >  if (idx &gt;= 0) {</span>
<span class="cstat-no" title="statement not covered" >    return arr[idx]</span>
  }
}
&nbsp;
/**
 ...
 */
<span class="fstat-no" title="function not covered" >function arrayFindLast(arr, pred, ctx) {</span>
<span class="cstat-no" title="statement not covered" >  var idx = arrayFindLastIndex(arr, pred, ctx)</span>
<span class="cstat-no" title="statement not covered" >  if (idx &gt;= 0) {</span>
<span class="cstat-no" title="statement not covered" >    return arr[idx]</span>
  }
}
 ...
 */
<span class="fstat-no" title="function not covered" >function arrayFindIndex(arr, pred, ctx) {</span>
<span class="cstat-no" title="statement not covered" >  for (var i = 0; i &lt; arr.length; ++i) {</span>
<span class="cstat-no" title="statement not covered" >    if (pred.call(ctx, arr[i], i, arr)) {</span>
 ...
 */
<span class="fstat-no" title="function not covered" >function arrayFindLastIndex(arr, pred, ctx) {</span>
<span class="cstat-no" title="statement not covered" >  for (var i = arr.length - 1; i &gt;= 0; --i) {</span>
<span class="cstat-no" title="statement not covered" >    if (pred.call(ctx, arr[i], i, arr)) {</span>
<span class="cstat-no" title="statement not covered" >      return i</span>
    }
  }
