...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-newrelic/node_modules/newrelic/lib/metrics/normalizer.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-newrelic/node_modules/newrelic/lib/metrics/normalizer.js</span></h1>
    <h2>
        
        Statements: <span class="metric">17.2% <small>(16 / 93)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-newrelic/node_modules/newrelic/lib/metrics/</a> &#187; normalizer.js</div>
</div>
<div class="body">
 ...
 *                    connection.
 */
MetricNormalizer.prototype.load = <span class="fstat-no" title="function not covered" >function load(json) {</span>
<span class="cstat-no" title="statement not covered" >  if (json) {</span>
<span class="cstat-no" title="statement not covered" >    this.rules = []</span>
<span class="cstat-no" title="statement not covered" >    logger.debug("Received %s %s normalization rule(s) from the server",</span>
...
<span class="cstat-no" title="statement not covered" >      if (!arrUtil.find(this.rules, deepEqual.bind(null, rule))) {</span>
<span class="cstat-no" title="statement not covered" >        this.rules.push(rule)</span>
<span class="cstat-no" title="statement not covered" >        logger.trace("Loaded %s normalization rule: %s", this.type, rule)</span>
      }
    }, this)
&nbsp;
     ...
     */
<span class="cstat-no" title="statement not covered" >    this.rules.sort(<span class="fstat-no" title="function not covered" >function cb_sort(a, b) {</span></span>
<span class="cstat-no" title="statement not covered" >      return a.precedence - b.precedence</span>
    })
&nbsp;
<span class="cstat-no" title="statement not covered" >    logger.debug("Loaded %s %s normalization rule(s).",</span>
 ...
 */
MetricNormalizer.prototype.loadFromConfig = <span class="fstat-no" title="function not covered" >function loadFromConfig() {</span>
...
<span class="cstat-no" title="statement not covered" >        return logger.error(</span>
          {rule: rule},
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      var precedence = rule.precedence</span>
<span class="cstat-no" title="statement not covered" >      var terminal = rule.terminate_chain</span>
...
<span class="cstat-no" title="statement not covered" >      var reverse = this.config.feature_flag.reverse_naming_rules</span>
<span class="cstat-no" title="statement not covered" >      var insert = arrUtil.findIndex(this.rules, <span class="fstat-no" title="function not covered" >function findRule(r) {</span></span>
<span class="cstat-no" title="statement not covered" >        return reverse</span>
          ? r.precedence &gt;= json.eval_order
          : r.precedence &gt; json.eval_order
      })
<span class="cstat-no" title="statement not covered" >      if (insert === -1) {</span>
<span class="cstat-no" title="statement not covered" >        this.rules.push(new Rule(json))</span>
      } else {
<span class="cstat-no" title="statement not covered" >        this.rules.splice(insert, 0, new Rule(json))</span>
      }
    }, this)
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (rules &amp;&amp; rules.ignore &amp;&amp; rules.ignore.length &gt; 0) {</span>
<span class="cstat-no" title="statement not covered" >    rules.ignore.forEach(<span class="fstat-no" title="function not covered" >function cb_forEach(pattern) {</span></span>
<span class="cstat-no" title="statement not covered" >      this.addSimple(pattern)</span>
    }, this)
  }
}
&nbsp;
 ...
 */
MetricNormalizer.prototype.addSimple = <span class="fstat-no" title="function not covered" >function addSimple(pattern, name) {</span>
 ...
 */
MetricNormalizer.prototype.normalize = <span class="fstat-no" title="function not covered" >function normalize(path) {</span>
...
<span class="cstat-no" title="statement not covered" >    var applied = rule.apply(last)</span>
<span class="cstat-no" title="statement not covered" >    if (!rule.matched) {</span>
<span class="cstat-no" title="statement not covered" >      continue</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (rule.ignore) {</span>
...
<span class="cstat-no" title="statement not covered" >      normalized = applied</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      this.emit('appliedRule', rule, normalized, last)</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      logger.trace({rule: rule, type: this.type},</span>
...
<span class="cstat-no" title="statement not covered" >      logger.trace({rule: rule}, "Terminating normalization.")</span>
