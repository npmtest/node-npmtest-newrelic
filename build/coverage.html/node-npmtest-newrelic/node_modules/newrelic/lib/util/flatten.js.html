...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-newrelic/node_modules/newrelic/lib/util/flatten.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-newrelic/node_modules/newrelic/lib/util/flatten.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-newrelic/node_modules/newrelic/lib/util/</a> &#187; flatten.js</div>
</div>
<div class="body">
...
&nbsp;
  for (var key in obj) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (seen.indexOf(obj[key]) &gt; -1) {
