...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-newrelic/node_modules/newrelic/lib/transaction/trace/aggregator.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-newrelic/node_modules/newrelic/lib/transaction/trace/aggregator.js</span></h1>
    <h2>
        
        Statements: <span class="metric">11.11% <small>(10 / 90)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-newrelic/node_modules/newrelic/lib/transaction/trace/</a> &#187; aggregator.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >  this.syntheticsTraces = []</span>
...
<span class="cstat-no" title="statement not covered" >    var name = transaction.name</span>
<span class="cstat-no" title="statement not covered" >    var duration = trace.getDurationInMillis()</span>
<span class="cstat-no" title="statement not covered" >    var apdexT = transaction.metrics.apdexT</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (transaction.syntheticsData &amp;&amp; this.syntheticsTraces.length &lt; 20) {</span>
<span class="cstat-no" title="statement not covered" >      this.syntheticsTraces.push(trace)</span>
    } else <span class="cstat-no" title="statement not covered" >if (this.isBetter(name, duration, apdexT)) {</span>
...
<span class="cstat-no" title="statement not covered" >  var tracesToAggregate = 0</span>
<span class="cstat-no" title="statement not covered" >  var encodedTraces = []</span>
<span class="cstat-no" title="statement not covered" >  var errored = false</span>
<span class="cstat-no" title="statement not covered" >  var normalTrace = null</span>
&nbsp;
  // Synthetics
<span class="cstat-no" title="statement not covered" >  for (var i = 0, len = this.syntheticsTraces.length; i &lt; len; ++i) {</span>
<span class="cstat-no" title="statement not covered" >    this.syntheticsTraces[i].generateJSON(resultAggregator)</span>
<span class="cstat-no" title="statement not covered" >    tracesToAggregate++</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (this.trace) {</span>
<span class="cstat-no" title="statement not covered" >    var max = this.trace.transaction.agent.config.max_trace_segments</span>
<span class="cstat-no" title="statement not covered" >    if (this.trace.segmentsSeen &gt; max) {</span>
...
<span class="cstat-no" title="statement not covered" >    normalTrace = this.trace</span>
<span class="cstat-no" title="statement not covered" >    this.noTraceSubmitted = 0</span>
<span class="cstat-no" title="statement not covered" >    this.trace.generateJSON(resultAggregator)</span>
<span class="cstat-no" title="statement not covered" >    tracesToAggregate++</span>
  } else {
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (tracesToAggregate === 0) {</span>
...
<span class="cstat-no" title="statement not covered" >      callback(null, null, null)</span>
    })
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  function resultAggregator(err, encoded) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    encodedTraces.push(encoded)</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (encodedTraces.length === tracesToAggregate) {</span>
<span class="cstat-no" title="statement not covered" >      callback(null, encodedTraces, normalTrace)</span>
    }
  }
}
&nbsp;
...
<span class="cstat-no" title="statement not covered" >  var isOverThreshold</span>
&nbsp;
